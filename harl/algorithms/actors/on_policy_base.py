...
from harl.utils.models_tools import update_linear_schedule, update_fragment_schedule_with_decay
...
class OnPolicyBase:
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        self.prod_prob_weight = args.get("prod_prob_weight", 0.5)
    ...
    def fragment_lr_decay(self, episode, episodes):
        ...
        Args:
            ...
            episodes: (int) total number of training episodes.
        """
        update_fragment_schedule_with_decay(self.actor_optimizer, episode, episodes, self.lr)
