...
class OnPolicyActorBuffer:
    ...
    # get sampler for feed_forward_generator_actor
    def get_sampler_for_feed_forward_generator_actor(self, actor_num_mini_batch, mini_batch_size=None):
    ...
    def feed_forward_generator_actor(
        self, advantages, actor_num_mini_batch=None, mini_batch_size=None, sampler=None
    ):
    ...
    # get sampler for naive_recurrent_generator_actor
    def get_sampler_for_naive_recurrent_generator_actor(self, actor_num_mini_batch):
        ...
        return torch.randperm(n_rollout_threads).numpy()
    

    def naive_recurrent_generator_actor(self, advantages, actor_num_mini_batch, sampler=None):
    ...
    # get sampler for recurrent_generator_actor
    def get_sampler_for_recurrent_generator_actor(self, actor_num_mini_batch, data_chunk_length):
        episode_length, n_rollout_threads = self.actions.shape[0:2]
        batch_size = n_rollout_threads * episode_length
    ...
    def recurrent_generator_actor(self, advantages, actor_num_mini_batch, data_chunk_length, sampler=None):
        """Training data generator for actor that uses RNN network.
